...
async function ORM(session) {
  ...
  const orm = {};
  new (Function.prototype.bind.apply(Function, [null, 'client', 'export_object', session.client_js]))()(export_object.client, orm);
  //await import(/* webpackIgnore: true */`data:text/javascript;charset=utf-8,` + encodeURIComponent(session.client_js));
